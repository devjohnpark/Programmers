// 문제 정의: 테두리 좌표애서 시작점부터 도착지점까지 최단거리 탐색을 해서 측정해라.
...
// 3. 시작점에서 도착지점까지 bfs로 상하좌우 방향으로 좌표를 이동하면서 최단거리를 구한다. (무가중치 그래프이므로 bfs가 적합)
// 4. 최단거리를 2로 나눠서 원래의 크기로 변경해서 반환
